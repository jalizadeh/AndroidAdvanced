...
public class Fragment_Tab1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_1_top_and_bottom_app_bars, container, false);

        Button btnTest = (Button) view.findViewById(R.id.btnTest_v3);
        btnTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(getActivity(), "Testing Button Tab 1", Toast.LENGTH_SHORT).show();
