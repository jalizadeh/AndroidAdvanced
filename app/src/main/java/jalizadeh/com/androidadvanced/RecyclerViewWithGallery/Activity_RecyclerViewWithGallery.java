...
import jalizadeh.com.androidadvanced.RecyclerViewWithGallery.MyRecyclerViewAdapter;

public class Activity_RecyclerViewWithGallery extends AppCompatActivity {
    private static final String TAG = "Activity_RecyclerViewWi";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycler_view_with_gallery);
    ...
    private void initRecyclerView(){
        ...
        RecyclerView recyclerView = findViewById(R.id.recyclerView15);
